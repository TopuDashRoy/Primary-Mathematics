...
public class leap implements ActionListener,MenuListener
{
    JFrame jfm2;
    JPanel jp,jp2,jp3;
    JTextField jt1,jt2;
    ...
    leap()
    {
        ...
        jfm2.setJMenuBar(mb);
        jp=new JPanel();
        jl=new JLabel("<html><h1 style=\"color:blue;text-align:center;\">Welcome</h1><h1 style=\"color:blue;text-align:center;\">To</h1><h1 style=\"color:red;text-align:center;\">Guessing Leap Year.</h1></html>");
        jp.add(jl);
        jfm2.add(jp);
        ...
        jla=new JLabel("");
        jp.add(jla);
        jl=new JLabel("<html><h3>Enter a year:</h3></html>",jl.CENTER);
        jp.add(jl);
        jp2=new JPanel();
        ...
        if(e.getSource()==jb)
        {
            ...
            else
            {
                try
                {
                    ...
                    if((num2%4==0 && num2%100!=0) || (num2%400==0 && num2%100!=0))
                        JOptionPane.showMessageDialog(jfm2, "This is a leap year","Answer", JOptionPane.INFORMATION_MESSAGE);
                    else
                         JOptionPane.showMessageDialog(jfm2, "This is not a leap year","Answer", JOptionPane.INFORMATION_MESSAGE);
