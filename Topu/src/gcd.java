...
public class gcd implements ActionListener,MenuListener
{
    JFrame jfm2;
    JPanel jp,jp2,jp3;
    JTextField jt1,jt2;
    ...
    gcd()
    {
        ...
        jfm2.setJMenuBar(mb);
        jp=new JPanel();
        jl=new JLabel("<html><h1 style=\"color:blue;text-align:center;\">Welcome</h1><h1 style=\"color:blue;text-align:center;\">To</h1><h1 style=\"color:red;text-align:center;\">Greatest Common Divisor</h1></html>");
        jp.add(jl);
        jfm2.add(jp);
        ...
        if(e.getSource()==jb)
        {
            ...
            else
            {
                try
                {
                    ...
                    JOptionPane.showMessageDialog(jfm2, "GCD of these numbers is: "+hcf,"Answer", JOptionPane.INFORMATION_MESSAGE);
